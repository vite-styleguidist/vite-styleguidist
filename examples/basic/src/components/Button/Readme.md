...
_Note: `rsg-example` module is an alias defined by the [moduleAliases](https://github.com/vite-styleguidist/vite-styleguidist/blob/main/docs/Configuration.md#modulealiases) config option._
