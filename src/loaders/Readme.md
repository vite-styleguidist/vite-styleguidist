...
- `utils/getProps`, `sortProps` — post-process react-docgen output (`rsg-props:*`);
- `utils/chunkify`, `parseExample`, `getImports`, `highlightCode` — split Markdown files into text and playground examples (`rsg-examples:*`);
